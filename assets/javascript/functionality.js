//firebase
var config = {
  apiKey: "AIzaSyDUAmt08PgAB6p6MUXCgDyErCZXMqShBQM",
  authDomain: "super-cool-dash-2.firebaseapp.com",
  databaseURL: "https://super-cool-dash-2.firebaseio.com",
  projectId: "super-cool-dash-2",
  storageBucket: "super-cool-dash-2.appspot.com",
  messagingSenderId: "414433702445"
};
...
$(document).ready(function() {
  ...
  //clickhandler to newuser loginpage
  ...
  $("#submit").on("click", function(event) {
      event.preventDefault();
      userName = $("#nameform").val().trim();
      userEmail =$("#emailform").val().trim();
      userPassword = $("#passwordform").val();
      userAnimal = $("#animalform").val();
      userColor =  $("#colorform").val();
  ...
  function displayCuteAnimals() {
    database.ref().orderByChild("userName").equalTo(localUser).on("child_added", function(childSnapshot) {
        ...
        var animal = childSnapshot.val().userAnimal;
        console.log(animal);
